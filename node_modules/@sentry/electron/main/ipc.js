...
const ipcMainHooks = new node_events.EventEmitter();
let KNOWN_RENDERERS;
...
function handleEnvelope(client, options, env, contents) {
    ...
    if (eventAndAttachments) {
        ...
        if (ipcMainHooks.listenerCount('pageload-transaction') > 0 &&
            ...
            electronNormalize.registerProtocol(sesh.protocol, ipcUtil.namespace, (request) => {
                ...
                if (ipcUtil.urlMatches(request.url, 'start')) {
                    ...
                    try {
                        ...
                        core.debug.warn('sentry-electron received an invalid structured-log message');
                        return;
                    }
                    ...
                    try {
                        ...
                        core.debug.warn('sentry-electron received an invalid metric message');
                        return;
                    }
                    ...
                    if (contents) {
                        ...
                        try {
                            ...
                            core.debug.warn('sentry-electron received an invalid status message');
                            return;
                        }
...
exports.ipcMainHooks = ipcMainHooks;
